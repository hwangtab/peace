...
const nodes = [
  {
    year: '2007',
    title: '해군기지 건설 결정',
    desc: '제주 서귀포시 강정마을, 해군기지 예정지로 지정',
    color: 'sunset-coral',
  },
  {
    year: '2009',
    title: '민군복합항으로 전환',
    desc: "주민 94% 반대에도, 해군기지를 '관광미항'으로 이름만 바꿔 추진",
    color: 'sunset-coral',
  },
  {
    year: '2012',
    title: '구럼비 바위 발파',
    desc: '유네스코 생물권보전지역의 천연 용암 바위, 폭파로 파괴',
    color: 'sunset-coral',
  },
  {
    year: '2015',
    title: '국제평화상 수상',
    desc: "강정마을, IPB '숀 맥브라이드 평화상' 수상 — 세계가 인정한 평화운동",
    color: 'golden-sun',
  },
  {
    year: '2016',
    title: '해군기지 준공',
    desc: '주민 반대에도 불구하고 기지 완공',
    color: 'coastal-gray',
  },
  {
    year: '2018',
    title: '대통령 공식 사과',
    desc: '문재인 대통령, 강정마을 방문 — "절차적 정당성을 지키지 못했다"',
    color: 'golden-sun',
  },
  {
    year: '2023',
    title: '제1회 캠프 (11팀)',
    desc: '강정체육공원에서 평화음악캠프 시작',
    color: 'jeju-ocean',
  },
  {
    year: '2024',
    title: '평화음반 발매',
    desc: '『이름을 모르는 먼 곳의 그대에게』 13곡 수록',
    color: 'golden-sun',
  },
  {
    year: '2025',
    title: '기동함대사령부 창설',
    desc: '해군기지가 기동함대사령부로 승격. 미 해군 함정 기항이 본격화되며 제주가 미국의 군사 전략 거점으로 편입',
    color: 'sunset-coral',
  },
  {
    year: '2026',
    title: '제3회 캠프 (54팀)',
    desc: '해군기지 준공 10년, 역대 최대 규모 2박 3일 축제',
    color: 'golden-sun',
    badge: '올해',
  },
];
...
function buildNodesHtml() {
  return nodes
    .map((n, i) => {
      ...
      const dotExtra = isLast
        ? `box-shadow: 0 0 0 6px rgba(253,180,75,0.25); animation: pulse 2s infinite;`
        : '';
      ...
      const olheBadge = n.badge
        ? `<span style="display:inline-block;padding:4px 12px;background:#FDB44B;color:#1A2332;font-size:14px;font-weight:700;border-radius:20px;margin-left:6px;">${n.badge}</span>`
        : '';
