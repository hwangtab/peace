    ...
    return (
        <div className={`relative group ${className}`}>
            ...
            <select
                ...
                className={`font-serif text-xs sm:text-sm px-2 py-1 pr-8 border rounded transition-colors duration-300 bg-transparent appearance-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-jeju-ocean ${toneClasses} ${borderClasses}`}
