...
describe('EventFilter Component', () => {
  ...
  describe('Rendering', () => {
    it('renders all filter buttons', () => {
      render(<EventFilter selectedFilter="all" onFilterChange={mockOnFilterChange} />);
    ...
    it('renders press filter order correctly', () => {
      render(
        <EventFilter selectedFilter="all" onFilterChange={mockOnFilterChange} filterOrder="press" />
      );
  ...
  describe('Active State', () => {
    it('applies active styles to selected filter', () => {
      render(<EventFilter selectedFilter="camp-2023" onFilterChange={mockOnFilterChange} />);
  ...
  describe('Accessibility', () => {
    ...
    it('has descriptive aria-label for each button', () => {
      ...
      const inactiveButton = screen.getByLabelText(/^2023 캠프\s*$/);
