  ...
  return (
    <Section background="light-beige" className="min-h-screen flex items-center justify-center">
      <div className="text-center max-w-lg mx-auto px-4">
        <h1 className="typo-h2 !text-jeju-ocean mb-4">{t('common.error_title')}</h1>
        <p className="typo-body text-coastal-gray mb-8 whitespace-pre-line break-words">
          {t('common.error_message')}
        </p>

        {isDev && (
          <div className="bg-white p-6 rounded-2xl shadow-sm mb-8 text-start overflow-auto max-h-48 border border-ocean-sand">
