...
const Button = ({
  ...
  const baseClasses =
    'inline-flex items-center justify-center transition-[color,background-color,box-shadow,transform] duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-jeju-ocean text-center whitespace-normal break-words max-w-full active:scale-95 hover:scale-105';
  ...
  const variantClasses = {
    ...
    outline:
      'border-2 border-jeju-ocean text-jeju-ocean font-medium hover:bg-jeju-ocean hover:text-white bg-transparent shadow-md hover:shadow-lg',
    'white-outline':
      'border-2 border-cloud-white text-cloud-white font-medium hover:bg-white/10 bg-transparent shadow-md hover:shadow-lg',
  ...
  const resolvedHref = href && utmContent ? buildUtmUrl(href, utmContent) : href;
