      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-7xl mx-auto">
          <motion.div variants={fadeIn} className="bg-ocean-sand/30 p-8 rounded-2xl hover:bg-ocean-sand/50 transition-colors duration-300">
            <h3 className="font-serif text-2xl font-bold text-jeju-ocean mb-4">강정, 평화의 물결이 시작되는 곳</h3>
          ...
          <motion.div variants={fadeIn} className="bg-ocean-sand/30 p-8 rounded-2xl hover:bg-ocean-sand/50 transition-colors duration-300">
            <h3 className="font-serif text-2xl font-bold text-jeju-ocean mb-4">함께 걷는 평화의 여정</h3>
            <p className="text-base leading-relaxed text-coastal-gray">
          ...
          <motion.div variants={fadeIn} className="bg-ocean-sand/30 p-8 rounded-2xl hover:bg-ocean-sand/50 transition-colors duration-300">
            <h3 className="font-serif text-2xl font-bold text-jeju-ocean mb-4">매년 이어지는 평화의 약속</h3>
            <p className="text-base leading-relaxed text-coastal-gray">
          ...
          <motion.div variants={fadeIn} className="bg-ocean-sand/30 p-8 rounded-2xl hover:bg-ocean-sand/50 transition-colors duration-300">
            <h3 className="font-serif text-2xl font-bold text-jeju-ocean mb-4">경계를 넘어선 연대의 울림</h3>
            <p className="text-base leading-relaxed text-coastal-gray">
