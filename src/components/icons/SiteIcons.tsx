...
export const HiOutlineMenu: React.FC<IconProps> = (p) => (
  <Hi {...p} paths={['M4 6h16M4 12h16M4 18h16']} />
);
export const HiOutlineX: React.FC<IconProps> = (p) => (
  <Hi {...p} paths={['M6 18L18 6M6 6l12 12']} />
);
