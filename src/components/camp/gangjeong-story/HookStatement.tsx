...
const HookStatement: React.FC<Props> = ({ variant = 'camp' }) => {
  ...
  return (
    <div ref={sectionRef} className="relative min-h-[50vh] md:min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className={`absolute inset-0 backdrop-blur-[1px] bg-radial-[ellipse_at_center] ${variant === 'home' ? 'from-black/60 via-black/30 to-black/20' : 'from-black/60 via-black/30 to-transparent'}`} />
