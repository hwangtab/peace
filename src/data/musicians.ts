...
export const musicians: Musicians = [
  ...
  },
  {
    ...
    description: "평범한 사람들의 자기창조성을 일깨우는 바투카다 커뮤니티 블로꾸 자파리와, 당신과 우주의 행복에 기여하는 예술단체 뽈레뽈레가 함께 결성한 연합팀입니다. 2026 강정피스앤뮤직캠프에서 연대와 환대의 에너지를 담아 공연을 선보입니다.",
    genre: ["바투카다", "퍼포먼스"],
    trackTitle: "",
  ...
  },
  {
    ...
    description: "첫 싱글 'EXODUS'로 한국 음악씬에 출사표를 던진 포스트 하드코어 밴드입니다. 일상 속 불합리와 혐오, 차별, 그리고 꿈을 쫓는 자들을 폄하하는 사회에서 벗어나고자 하는 욕망을 음악에 담습니다. 타이트한 랩과 호소력 짙은 보컬, 강렬한 기타와 섬세한 프로덕션으로 해방감과 카타르시스를 선사합니다.",
    genre: ["포스트 하드코어", "록"],
    trackTitle: "EXODUS",
  ...
  },
  {
    id: 21,
    name: "Meridies",
    shortDescription: "심포닉 블랙 메탈과 데스 메탈을 기반으로 한 1인 프로젝트로, 이상 등 한국 문학을 가사에 활용합니다",
  ...
  },
  {
    ...
    description: "2015년부터 노래를 만들고 부르는 예술가이자 활동가입니다. 기억하고 싶은 순간들을 노래로 만들어 듣는 이에게 위로가 되길 바랍니다. 혼자가 아닌 모두가 함께 행복하게 사는 세상을 꿈꿉니다.",
    genre: ["인디", "포크", "싱어송라이터"],
    trackTitle: "",
  ...
  },
  {
    id: 25,
    name: "불가사리 즉흥세션",
    shortDescription: "2003년부터 이어온 아방가르드·즉흥·실험 예술 정기 발표회로, 300회 이상의 무대를 열어온 한국 실험음악의 산실입니다",
  ...
  },
  {
    ...
    description: "선경은 싱어송라이터 뮤지션이면서 우리 주변의 자연과 생명의 이미지를 도자기 인형으로 만드는 예술가이다.",
    genre: ["싱어송라이터", "포크"],
    trackTitle: "",
  ...
  },
  {
    id: 33,
    name: "송인효",
    shortDescription: "삶의 경험과 내면의 성찰을 담백한 멜로디와 솔직한 가사로 기록하는 싱어송라이터입니다",
  ...
  },
  {
    id: 34,
    name: "삼각전파사",
    shortDescription: "전자음악가이자 SF 작가 장호진의 솔로 프로젝트로, 사회의 구조적 모순을 실험적 전자음악으로 표현합니다",
  ...
  },
  {
    id: 36,
    name: "오재환",
    shortDescription: "여러 투쟁현장에 음악으로 연대해온 포크 싱어송라이터로, 제1회부터 강정피스앤뮤직캠프에 꾸준히 참여하고 있습니다",
  ...
  },
  {
    id: 37,
    name: "온가영",
    shortDescription: "부산을 기반으로 활동하는 싱어송라이터로, 따뜻한 음색의 간결한 어쿠스틱 음악을 만들고 부릅니다",
  ...
  },
  {
    id: 39,
    name: "윤숭",
    shortDescription: "생명과 죽음, 절망 속에서도 걸어나가는 여정을 서정적으로 노래하는 포크 싱어송라이터입니다",
  ...
  },
  {
    ...
    description: "싱어송라이터 준리는 캘리포니아 로스앤젤레스에서 자라며 기타를 전공했다. 이후 미국에서 서울, 제주도까지 활동을 이어가고 있으며, folk, blues, rock, pop 등 여러 장르의 영향을 받은 다채로운 컬러의 뮤지션이다.",
    genre: ["인디"],
    trackTitle: "",
  ...
  },
  {
    id: 46,
    name: "Jinu Konda",
    shortDescription: "어둡고 허스키한 목소리의 컨트리 블루스 뮤지션으로, 2018년부터 홍대 씬에서 활동하며 모던 고딕 이야기를 노래합니다",
  ...
  },
  {
    ...
    description: "Sitar와 Bansuri를 연주하는 명상음악가. 인도의 고요하고 깊은 소리에 매료되어 여러 스승들에게 배웠으며, 명상음악 앨범을 다수 발매하고 유튜브 채널 Lotus Relaxing Music을 운영하고 있다.",
    genre: ["명상음악", "월드뮤직"],
    trackTitle: "",
  ...
  },
  {
    ...
    description: "음악 순례를 통한 창작과 공연을 전개하는 싱어송라이터로 김강곤(아코디언), 조애란(소리)과 함께 '산오락회' 활동을 이어가며 강정 운동에 지속적으로 연대해왔습니다.",
    genre: ["인디"],
    trackTitle: "",
  ...
  },
  {
    id: 55,
    name: "허정혁",
    shortDescription: "유재하음악경연대회 출신의 포크 싱어송라이터로, 정규앨범 '봉오리 시절'이 한국대중음악상 최우수 포크 음반 후보에 올랐습니다",
