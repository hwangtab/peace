...
export const ASSIGN_TABLES: AssignTable[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      [
        '3층',
        '블로꾸 여성 9인, 장하나, 두리, 타투라쿤',
        '블로꾸 여성 3인, 장하나, 두리, 타투라쿤',
        '김동산과 블루이웃 5인',
      ],
    ],
  },
...
export const ETC_LODGING: { name: string; detail: string }[] = [
  ...
  { name: '김동산과 블루이웃', detail: '8일(3인) 새방밧 숙박 / 5·6·7일 위 숙소 중 배분' },
  {
    name: '정정훈',
    detail:
      '3·4일 새방밧 숙박 / 5·7일 성프란치스코평화센터 5층 다락 숙박 / 6일 누림펜션(서귀포시 강정하로 36) 숙박',
  },
...
export const STAFF: { role: string; people: string }[] = [
  ...
  {
    role: '현장 운영 / 자원봉사자 조직·운영 / 무대 및 공간 디자인·제작',
    people: '윰, 이상, 이한주, 정진석, 장하나',
  },
  { role: '다큐 제작', people: '치치, 하띠, 황경하' },
  { role: '아카이브 기록(사진)', people: '권동희, 김동희' },
  {
    role: '자원봉사자',
    people: '타투라쿤, 그린씨, 조은, 애나, 유니타, 양상, 정정훈, 버들, 타라, 찬, 자파리 3인',
  },
];
