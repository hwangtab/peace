...
export const ASSIGN_TABLES: AssignTable[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['2층 3번', '블로꾸 남자 4인', 'Joon Lee 외 1인', '하주원, 오재환'],
      ['2층 4번', '치치 동반 여성 2인', '치치 동반 여성 2인', '치치 동반 여성 2인'],
      ['3층', '블로꾸 여성 9인, 장하나, 두리, 타투라쿤', '블로꾸 여성 3인, 장하나, 두리, 타투라쿤', '김동산과 블루이웃 5인'],
    ],
  },
  {
    title: '새방밧',
    headers: ['방', '6/4', '6/5', '6/6', '6/7'],
    rows: [
      ['2층 왼쪽방', 'TAGI+반려견', 'TAGI+반려견', 'TAGI+반려견', 'TAGI+반려견'],
      ['2층 오른쪽방', '정진석, 치치, 황경하, 정정훈', '제트싸이저, 사이트, 사바하', '안티 스트레스, 태준', '제트싸이저, 사이트, 사바하'],
    ],
  },
];
...
export const ETC_LODGING: { name: string; detail: string }[] = [
  ...
  { name: '김동산과 블루이웃', detail: '8일(3인) 새방밧 숙박 / 5·6·7일 위 숙소 중 배분' },
  { name: '정정훈', detail: '3·4일 새방밧 숙박 / 5·7일 성프란치스코평화센터 5층 다락 숙박 / 6일 누림펜션(서귀포시 강정하로 36) 숙박' },
  { name: '허정혁', detail: '6일 누림펜션(서귀포시 강정하로 36) 숙박' },
  { name: '임정득', detail: '6·7일 누림펜션(서귀포시 강정하로 36) 숙박' },
  { name: '윤숭 외 1인', detail: '5·6일 마린포트 리조트(강정동 2483-3) 숙박' },
];
...
export const STAFF: { role: string; people: string }[] = [
  ...
  { role: '자원봉사자', people: '타투라쿤, 그린씨, 조은, 애나, 유니타, 양상, 정정훈, 버들, 타라, 찬, 자파리 3인' },
];
