...
const campsKo: CampEvent[] = [
  ...
  },
  {
    ...
    description: '2026년 6월 5일(금)부터 7일(일)까지 2박 3일간 강정체육공원에서 열리는 제3회 강정피스앤뮤직캠프. 음악가 55팀 출연 확정.',
    location: '강정체육공원',
...
const campsEn: CampEvent[] = [
  ...
  },
  {
    ...
    description: 'The 3rd Gangjeong Peace Music Camp will be held at Gangjeong Sports Park from June 5 (Fri) to June 7 (Sun), 2026. 55 teams of musicians confirmed.',
