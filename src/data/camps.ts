  ...
  ko: {
    ...
    'camp-2025': {
      ...
      staff: [
        ...
        {
          role: '스텝 및 도움 주신 분들',
          members: ['든든', '려강', '카레', '개미', '수산', '지혜', '버들', '김성환', '이성준'],
        },
      ],
      collaborators: [
        '가장자리에서',
    ...
    'camp-2026': {
      participants: [
        ...
        { name: '최상돈 × 김강곤 × 정환진', musicianId: 48 },
        { name: '치치', musicianId: 49 },
        { name: '키타와 올겐', musicianId: 50 },
        { name: '태히언과 이나 데 제주', musicianId: 51 },
      ...
      staff: [
        { role: '총괄 디렉터(PM)', members: ['이상'] },
        { role: '기술·음향 감독', members: ['황경하', '곽민'] },
        { role: '아티스트 소통·의전', members: ['곽민', '박예찬', '자이', '황경하'] },
        { role: '장터·개더링 기획', members: ['남수', '자이'] },
        { role: '텀블벅·회계·구매', members: ['나장'] },
        { role: '홍보', members: ['이상', '나장', '황경하', '치치'] },
        { role: '디자인', members: ['김홍범', '나장'] },
  ...
  en: {
    'camp-2023': {
      ...
      staff: [
        {
          role: 'Planning',
          members: ['Jang Hana', 'Lee Sang', 'Hwang Gyeongha', 'Jarita', 'Eung', 'Andrea'],
        },
      ...
      collaborators: [
        "Gangjeong Village Residents' Committee Against the Naval Base",
        'Gangjeong Friends',
        'Gangjeong Peace Network',
        "Citizens' Solidarity for an Open Military",
        'St. Francis Peace Center Foundation',
        'Korean Peninsula Peace Action for 70 Years of Armistice',
        'Mothers Who Do Politics',
        'Peace Breeze',
      ],
    },
    'camp-2025': {
    ...
    'camp-2026': {
      participants: [
        ...
        { name: 'Choi Sangdon × Kim Ganggon × Jeong Hwanjin', musicianId: 48 },
        { name: 'Chichi', musicianId: 49 },
        { name: 'Kita & Olgen', musicianId: 50 },
        { name: 'Tehiun and Inna De Jeju', musicianId: 51 },
      ...
      staff: [
        { role: 'Director (PM)', members: ['Lee Sang'] },
        { role: 'Technical & Sound Director', members: ['Hwang Kyungha', 'Kwak Min'] },
        {
          role: 'Artist Liaison',
          members: ['Kwak Min', 'Park Yechan', 'Jai', 'Hwang Kyungha'],
        },
        { role: 'Market & Gathering', members: ['Namsu', 'Jai'] },
        { role: 'Crowdfunding & Finance', members: ['Najang'] },
        { role: 'Promotion', members: ['Lee Sang', 'Najang', 'Hwang Kyungha', 'Chichi'] },
        { role: 'Design', members: ['Kim Hongbeom', 'Najang'] },
        { role: 'Volunteer & Org Coordination', members: ['Lee Sang', 'Najang'] },
        {
          role: 'Site Operations & Stage',
        ...
        { role: 'Photo Archive', members: ['Kwon Donghee', 'Kim Donghee'] },
        {
          ...
          members: [
            ...
            'Tteng',
            'Jafari (3 members)',
            "Lee Hanju's acquaintances",
          ],
        },
      ],
      collaborators: [
        "Gangjeong Village Residents' Committee Against the Naval Base",
        'Gangjeong Daily Resistance Action',
        'Gangjeong Friends',
        'Gangjeong Peace Guild',
        'Madam Kang Hee Peace Fund',
        'Pioneers',
        'Gyeonggi Art Collective Cooperative',
        "Korean Public Service and Transport Workers' Union",
        "International Climate, Religion, and Citizens' Network",
        'Nodeul Night School for People with Disabilities',
        'Green Korea United',
        'Jogye Order of Korean Buddhism — Social Labor Committee',
        'The House Next to the Art Museum',
        'People Creating Jeju, the Demilitarized Peace Island',
        'St. Francis Peace Center',
        "Citizens' Group Independence",
        "Citizens' Solidarity for an Open Military",
        'People Against the Militarization of Space and Rocket Launches',
        'Association of Physicians for Humanism',
        "Disabled Women's Empathy",
        'Justice Party',
        'Mothers Who Do Politics',
        'Jeju Green Party',
        'Jeju Queer Pride Organizing Committee',
        'Jeju Peace and Human Rights Institute WAT',
        'Jihyangjip',
        "People's Solidarity for Participatory Democracy",
        'Catholic Diocese of Incheon, Justice and Peace Committee',
        'Catholic Diocese of Jeju, Gangjeong Chapel',
        'Commu Art Bridge Comma',
        'Kiwi Bird Station',
        'Palestine Peace Solidarity',
        'Solidarity of Islands for a Sea of Peace, Jeju Committee',
        'Hansalim Jeju Consumer Cooperative',
        'Hot Pink Dolphins',
