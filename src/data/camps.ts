...
const campsKo: CampEvent[] = [
  ...
  },
  {
    ...
    participants: [
      ...
      { name: '도그 라스트 페이지', musicianId: 19 },
      { name: '레인보우99', musicianId: 20 },
      { name: '메리디에스', musicianId: 21 },
      { name: '모모', musicianId: 10 },
      { name: '모허', musicianId: 22 },
      { name: '모레도토요일', musicianId: 7 },
      { name: '뮁', musicianId: 23 },
      { name: '머티리얼즈 파운드', musicianId: 24 },
      { name: '블로꾸 자파리 X 뽈레뽈레 X 동백작은학교', musicianId: 13 },
      { name: '불가사리 즉흥세션', musicianId: 25 },
      { name: '사바하', musicianId: 26 },
      { name: '사이트 with 제트싸이저', musicianId: 27 },
      { name: '서민기', musicianId: 28 },
