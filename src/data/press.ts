...
const pressItemsKo: PressItem[] = [
  {
    ...
    description:
      "평화를 향한 간절한 염원을 담은 음반 '이름을 모르는 먼 곳의 그대에게'의 발매 기념 공연이 관객들의 뜨거운 호응을 얻고 있다. 지난 10월 12일 강정마을에서 열린 첫 공연이 전석 매진된 데 이어, 오는 11월 2일 홍대 스페이스한강에서 예정된 두 번째 공연도 일찌감치 매진을 기록했다.",
  ...
  },
  {
    ...
    imageUrl:
      'https://flexible.img.hani.co.kr/flexible/normal/960/960/imgdb/original/2024/1008/20241008501862.jpg',
  },
  {
    id: 2,
    ...
    imageUrl:
      'https://img.khan.co.kr/news/2024/09/19/news-p.v1.20240919.2b72c5956ca04f74bed8fd9f0dd47766_P1.webp',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      '남수는 앨범 소개를 통해 "멀리 떨어져 있지만 우리는 결국 같은 땅에 살고 있다"며 "다른 세상에서 일어나는 일이 아니라 결국 같은 땅 위에서 벌어지고 있다. 멀리에 있지만 같은 마음과 소망을 품은 우리. 이름을 모르지만 서로의 안녕을 바라는 우리라고 전했다.',
  ...
  },
  {
    ...
    imageUrl:
      'https://images.khan.co.kr/article/2024/11/24/news-p.v1.20241124.37bd552a91f74c7db1d08c28705cc907_P1.webp',
  },
  {
    id: 7,
    ...
    description:
      '모레도토요일의 가장 큰 강점은 음악적 완성도와 메시지의 진정성, 그리고 실제 행동이 균형을 이루고 있다는 점이다. 모레도토요일은 자신들의 음악적 재능을 사회적 메시지 전달의 도구로 활용하면서도, 현장에서의 직접적인 행동을 통해 그 메시지를 실천하고 있다. 전설적인 다큐멘터리 사진가 고 최민식이 예술작업과 삶이 일치해야 한다고 강조했듯이, 모레도토요일의 삶과 신념은 그들의 음악에 특별한 무게감과 설득력을 더한다.',
  ...
  },
  {
    ...
    description:
      "'모레도토요일'이라는 이름에는 이상적인 순간을 지속하고자 하는 열망이 담겨있다. 제주 강정마을의 평화 프로그램 '섬띵피스'를 통해 만난 모레와 도토는 음악을 매개로 소통하며 하나의 예술적, 실천적 공동체를 형성했다. 이들은 강정마을 해군기지 건설을 둘러싼 갈등 속에서 단순한 음악 활동을 넘어 해군기지 앞 인간띠잇기 등 평화 지킴이로서 현장 활동도 병행하며, 예술과 실천의 조화로운 결합을 보여주고 있다.",
  ...
  },
  {
    ...
    description:
      "제주 강정마을의 평화 활동가들로 구성된 포크 듀오 모레도토요일이 오늘(25일) 신곡 'We will sail for your freedom'을 발매했다. 이 곡은 2016년 Emma Ringqvist가 팔레스타인 가자 지구의 여성들을 위해 작곡한 곡을 재해석한 작품이다. 원곡은 불법 봉쇄된 팔레스타인 가자 지구로 항해하던 13명의 여성 활동가들이 함께 만든 노래다. 이들은 가사에서 올리브나무를 통해 평화의 메시지를 전달한다. '할머니들이 심은 올리브나무'는 과거 평화로운 삶의 증거이며, '딸들이 새로운 씨앗을 심고 자라는 것을 지켜볼 수 있기를' 바라는 구절은 미래에 대한 희망을 상징적으로 표현한다.",
    imageUrl: 'https://mmagimg.speedgabia.com/2024/11/_we-will-sail-thumb.jpg',
  },
  {
    id: 10,
    title:
      "'자유롭다'고 믿는 사회 속 모순에 대해, 재즈 듀오 모모 'If this can be tolerated, what can't be?'what can't be?'",
    publisher: '월간 믹싱',
    date: '2024-11-27',
    url: 'https://mixing.co.kr/29415',
    description:
      "'If this can be tolerated, what can't be? Why we bear catastrophe if we're so free?'라는 가사는 자유를 말하는 사회에서 폭력이 용인되는 모순을 날카롭게 지적한다. 더불어 이는 우리가 왜 이를 감내하고 있는지에 대한 끊임없는 물음으로서, 반복되는 멜로디는 그들의 일상이 결코 단조롭거나 무의미하지 않음을, 오히려 그 속에 깃든 강인한 생명력과 희망이 얼마나 위대한 것인지를 전달한다.",
  ...
  },
  {
    ...
    description:
      "이서영은 '어느 날 산에 나 있는 깊은 터널을 지날 때 이런 그림이 떠올랐다. 숲의 가슴을 뚫고 그곳을 지나가는 사람들의 무리가 그려졌다. 터널을 지나가며 떠올렸던 그림이 이 노래로 번지게 되었다. 턱 끝까지 숨이 차올라도 삶을 고집할 수밖에 없는 우리는 무엇을 잃었을까, 무엇을 놓쳤을까. 사랑과 평화와 자유라는 이름이 내 마음속 깊은 터널에서부터 메아리치며 대답해 오는 것만 같았다'며 곡의 의도를 설명했다. 이어 '서로 다른 소리를 가진 악기들이 모여, 아름답게 일치되는 이 노래처럼 그렇게 노래하고 싶었다'며 '이 노래를 만들고 부르는 순간, 사랑과 평화와 자유에 한 뼘 더 가까워질 수 있었다. 듣는 이들에게도 함께 부르는 노래처럼 여겨질 수 있기를 바란다'고 전했다.",
  ...
  },
  {
    ...
    description:
      "이서영만의 독특한 음색과 서정적인 사운드스케이프가 돋보이는 '우리'는 피아노와 보컬을 중심으로 한 원곡에 일렉트릭 기타, 베이스, 플루겔혼이 더해진 풍성한 편곡이 특징이다. 특히 플루겔혼의 깊이 있는 음색은 곡의 시적 이미지를 한층 강화하며, 각 악기들은 독자적인 성부를 그리면서도 조화로운 앙상블을 이룬다.",
  ...
  },
  {
    ...
    description:
      '웹사이트에서는 프로젝트에 참여한 12팀의 뮤지션 소개와 각 음악가들이 전하는 평화 메시지를 만나볼 수 있다. 특히 제주 강정마을에서 결성된 포크듀오 모레도토요일, 네팔 출신 시타리스트 리테스 마하르잔이 참여한 Project Around Surround 등 다채로운 음악가들의 이야기가 담겨있다.',
    imageUrl:
      'https://images.khan.co.kr/article/2024/12/02/news-p.v1.20241202.02d6177fa7fd480381f431c60710a344_P1.webp',
  },
  {
    id: 17,
  ...
  },
  {
    ...
    description:
      '‘눈 앞의 마음’은 기존 반전 음악들과는 다른 접근방식이 돋보인다. 전쟁의 참상을 직접적으로 고발하거나 저항의 목소리를 내기보다, 일상의 작은 순간들과 개인의 감정선을 통해 평화의 가치를 이야기한다. “슬픔과 기쁨이 찾아오고 떠나가고 맴도네”라는 가사로 시작해 “모든 마음이 그곳에 닿기를 기도하고 노래하겠네”로 마무리되는 노랫말은 개인의 내면에서 시작해 세상을 향한 희망으로 확장된다.',
    imageUrl:
      'https://images.khan.co.kr/article/2025/01/16/news-p.v1.20250116.cc1325a1e49d403d9bc62e48a2268aa5_P1.webp',
  },
  {
    id: 25,
    ...
    description:
      '여울과 원걸로 구성된 나뭇잎들은 이번 곡에서도 특유의 조화로운 하모니를 선보인다. 여울의 맑은 음색과 원걸의 따뜻한 중저음이 만나 마치 두 개의 나뭇잎이 바람에 흔들리듯 자연스럽게 어우러진다. 어쿠스틱 기타와 쉐이커만을 사용한 미니멀한 편곡은 메시지의 순수성을 더욱 돋보이게 한다.',
    imageUrl: 'https://i3.ruliweb.com/img/25/01/16/1946d7c52aaafd4.jpeg',
  },
  {
    id: 26,
    title:
      '[강정의 자연을 담은 신비로운 사운드] Project Around Surround, 동서양 음악의 실험적 융합 선보여',
    publisher: '뉴스아트',
    date: '2025-01-17',
    url: 'https://www.news-art.co.kr/news/article.html?no=32718',
    description:
      '이번 작품은 강정의 자연 풍경을 청각적으로 재해석한다. 잔잔한 파도 소리에서 시작해 점차 한라산의 웅장함으로 이어지는 음악적 흐름은, 고대 인도의 라가와 현대 앰비언트 음악의 특징을 절묘하게 조화시킨다. 특히 시타르의 신비로운 음색과 첨단 사운드 디자인의 만남은 동양의 전통과 서양의 현대성을 잇는 가교 역할을 한다.',
  ...
  },
  {
    ...
    description:
      '가사는 청년들의 불안과 순수한 삶에 대한 갈망을 그려냈다. 특히 제주도는 대안적 삶의 가능성을 상징하며 희망을 담고 있다. 포크 본연의 매력으로 청자들에게 깊은 울림을 전한다.',
  ...
  },
  {
    ...
    imageUrl:
      'https://images.khan.co.kr/article/2025/02/06/news-p.v1.20250206.9e168b0306d64ee8ab38e308df22e191_P1.webp',
  },
  {
    id: 29,
    title:
      '전쟁과 폭력에 저항하는 12인의 음악가들, 평화를 노래하다 - 『이름을 모르는 먼 곳의 그대에게』 발매',
    publisher: '뉴스아트',
    date: '2025-02-07',
    url: 'https://www.news-art.co.kr/news/article.html?no=32724',
    description:
      '전쟁과 폭력이 일상이 되어버린 세계 곳곳의 평화를 염원하는 음악가들이 하나의 목소리를 냈다. 우크라이나 전쟁의 포화 속에서 희생되는 무고한 생명들, 가자지구에서 계속되는 민간인 학살, 그리고 70년이 넘도록 풀리지 않는 한반도 분단의 아픔까지, 각기 다른 현장의 고통을 음악으로 담아낸 음반 『이름을 모르는 먼 곳의 그대에게』가 2월 7일 오후 2시 디지털 음원으로 발매된다.',
  ...
  },
  {
    ...
    description:
      "올해로 2회째를 맞는 강정피스앤뮤직캠프가 오는 14일 할망물식당 일대(서귀포시 강정동 2835-1)에서 개최된다. 이번 캠프는 '평화를 노래하는 모든 이들의 축제'를 슬로건으로 내걸고 다양한 장르의 뮤지션들이 참여해 평화의 메시지를 전한다.",
  ...
  },
  {
    ...
    description:
      '제2회 강정피스앤뮤직캠프가 성황리에 막을 내렸다. 이번 행사는 평화를 염원하는 시민들과 예술가들이 함께 어우러져 반전과 평화의 가치를 공유하는 뜻깊은 자리였다.',
  ...
  },
  {
    ...
    description:
      '강정피스앤뮤직캠프 조직위원회는 기자회견을 열고 평화적인 문화행사 개최 보장과 시민들의 문화향유권 보장을 촉구했다.',
...
const pressItemsEn: PressItem[] = [
  {
    id: 4,
    title:
      "Sold out: 'To You in a Distant Place Whose Name I Don't Know,' a stage by musicians singing for peace",
    publisher: 'News Art',
    date: '2024-10-31',
    url: 'https://www.news-art.co.kr/news/article.html?no=32660',
    description:
      "The release concerts for the album 'To You in a Distant Place Whose Name I Don't Know' have drawn an enthusiastic response. After the October 12 show in Gangjeong sold out, the November 2 concert at Space Hangang in Hongdae also sold out early.",
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241044/art_17303642770961_5c659f.jpg',
  },
  {
    id: 1,
    ...
    url: 'https://www.hani.co.kr/arti/culture/culture_general/1161535.html',
    description:
      'Planner Jang Hana said it became a meaningful opportunity for a new generation of musicians to participate in making socially engaged music, and expressed hope that the collaboration of artists with diverse colors and experiences would inspire rich musical imagination around the theme of peace.',
    imageUrl:
      'https://flexible.img.hani.co.kr/flexible/normal/960/960/imgdb/original/2024/1008/20241008501862.jpg',
  },
  {
  ...
  },
  {
    ...
    url: 'https://www.news-art.co.kr/news/article.html?no=32254',
    description:
      "News of war from Ukraine to Israel-Palestine and tensions on the Korean Peninsula colors daily life with anxiety and fear. Against this backdrop, 'To You in a Distant Place Whose Name I Don't Know' holds the musicians' earnest desire to deliver a message of peace worldwide through music.",
    imageUrl: 'https://www.news-art.co.kr/data/photos/20240936/art_17253322573648_23573e.jpg',
  },
  {
    id: 5,
    title:
      "Namsu releases new song 'Hello (To You in a Distant Place)' - We ultimately live on the same land",
    publisher: 'Monthly Mixing',
    date: '2024-11-22',
    url: 'https://mixing.co.kr/29252',
    description:
      'In the album notes, Namsu says, "Though we are far apart, we ultimately live on the same land. What happens is not in another world but on the same ground. We may be far, but we share the same hearts and wishes. We don\'t know each other\'s names, but we wish each other well."',
    imageUrl: 'https://mmagimg.speedgabia.com/2024/11/_namsu-bye-thumb.jpg',
  },
  {
    id: 6,
    title:
      "A melody of solidarity beyond distance: artist Namsu releases single 'Hello (To You in a Distant Place)'",
    publisher: 'Sports Kyunghyang',
    date: '2024-11-24',
    url: 'https://sports.khan.co.kr/article/202411240607003',
    description:
      'The lyrics remind us of humanity that persists amid division and conflict. The line "If the same wind is within you and me" points to a universal longing, and "to you whose name I don\'t know" symbolizes our connection even in anonymity.',
    imageUrl:
      'https://images.khan.co.kr/article/2024/11/24/news-p.v1.20241124.37bd552a91f74c7db1d08c28705cc907_P1.webp',
  },
  {
  ...
  },
  {
    ...
    url: 'https://www.headlinejeju.co.kr/news/articleView.html?idxno=558061',
    description:
      "The name 'MoredoSaturday' carries a desire to sustain ideal moments. More and Doto met through the Gangjeong peace program 'Something Peace' and formed an artistic, practical community through music. Amid conflicts over the naval base, they go beyond music to on-site peace actions such as human-chain protests, showing a harmonious blend of art and practice.",
    imageUrl: 'https://www.headlinejeju.co.kr/news/photo/202411/558061_449548_4751.jpg',
  },
  {
    id: 9,
  ...
  },
  {
    ...
    url: 'https://www.news-art.co.kr/news/article.html?no=32644',
    description:
      '"If this can be tolerated, what can\'t be? Why we bear catastrophe if we\'re so free?" raises a sharp question about a world order filled with war and violence. It asks how a society that believes it is free tolerates such destruction. MOMO captures conflicts across the globe and challenges our posture of endurance toward these "disasters."',
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241043/art_172957614531_cb2e06.jpg',
  },
  {
    id: 13,
  ...
  },
  {
    ...
    url: 'https://bbs.ruliweb.com/news/read/204826',
    description:
      "With her distinctive timbre and lyrical soundscape, 'We' expands the piano-and-vocal original with electric guitar, bass, and flugelhorn. The flugelhorn deepens the song's poetic imagery, and the instruments create a harmonious ensemble while drawing their own voices.",
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241043/art_17295699483884_fb2af4.jpg',
  },
  {
    id: 15,
    title:
      "Jeong Jinseok's 'Is This Your Land or Mine' - resistance blues capturing the tragedy of Soseong-ri",
    publisher: 'News Art',
    date: '2024-10-11',
    url: 'https://www.news-art.co.kr/news/article.html?no=32582',
    description:
      'Jeong Jinseok succeeds in fusing traditional blues with Korean sensibilities. His Gyeongsang dialect vocals recall U.S. Southern blues singers and Korean rural oral traditions, perfectly aligning with the theme and making listeners feel the voices of Soseong-ri residents.',
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241041/art_17286175936167_e2bc82.jpg',
  },
  {
    id: 16,
    title:
      "The journey of musicians singing peace in 'To You in a Distant Place...' meets us again on the archive website",
    publisher: 'Sports Kyunghyang',
    date: '2024-12-02',
    url: 'https://sports.khan.co.kr/article/202412020551003',
    description:
      'The website introduces 12 participating musicians and their messages of peace. Stories include the Gangjeong-formed folk duo MoredoSaturday and Nepalese sitarist Ritesh Maharjan of Project Around Surround, among many others.',
    imageUrl:
      'https://images.khan.co.kr/article/2024/12/02/news-p.v1.20241202.02d6177fa7fd480381f431c60710a344_P1.webp',
  },
  {
    ...
    url: 'https://www.news-art.co.kr/news/article.html?no=32617',
    description:
      'Namsu\'s "Hello (To You in a Distant Place)" recalls pure humanity amid the complexities of modern society. With a simple melody and restrained arrangement, it focuses on the message while delivering deep resonance, and the somber piano accompaniment quietly leads the atmosphere, revealing Namsu\'s unique musical color.',
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241042/art_17290693286107_ca5934.png',
  },
  {
    id: 18,
  ...
  },
  {
    ...
    url: 'https://www.news-art.co.kr/news/article.html?no=32691',
    description:
      'The song\'s real achievement lies in how it exposes the violence of war. Instead of direct anger or resistance, it summons concrete memories of peaceful moments to reveal the absurdity of war. Intimate lines like "the night we leaned our shoulders together" suggest that war destroys not only spaces and lives but also our most precious relationships.',
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241249/art_17333740286862_d4e1e2.jpg',
  },
  {
    id: 20,
    title:
      "A folk rock capturing the tragedy of modern civilization - 'Wave' by Kim Dongsan and Blueeewoot",
    publisher: 'News Art',
    date: '2024-11-20',
    url: 'https://news.mt.co.kr/mtview.php?no=2024122015155125322&type=1',
    description:
      "Musically, 'Wave' is a notable achievement. The band's tight interplay stands out: Ryu Jooncheol's organ sets a lyrical mood, and Lee Inwoo's bass and Kim Yejun's drums build a solid rhythm section. The band's rising performance toward the end effectively delivers the weight of the questions in the lyrics.",
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241147/art_17320679353068_c724d0.jpg',
  },
  {
    id: 21,
    ...
    url: 'https://www.news-art.co.kr/news/article.html?no=32649',
    description:
      "Through the story of an innocent girl, the song reveals the tragedy of war and presents a new way to convey anti-war messages. Jai's distinctive vocals and HANASH's experimental sound illuminate the heavy theme from a new angle, leaving a deeper resonance.",
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241043/art_17298221431005_afab11.jpg',
  },
  {
    id: 23,
    ...
    url: 'https://www.news-art.co.kr/news/article.html?no=32695',
    description:
      "Leafs approach the vast theme of peace from a personal perspective, using folk's intimate sensibility. Unlike many anti-war songs that directly accuse the horrors of war, 'Heart in Front of My Eyes' speaks of the value of peace through everyday moments and personal emotions.",
    imageUrl: 'https://www.news-art.co.kr/data/photos/20241250/art_17338217947325_88f251.jpg',
  },
  {
    id: 24,
  ...
  },
  {
    ...
    url: 'https://bbs.ruliweb.com/news/read/206470',
    description:
      "The duo Yeo-ul and Wongirl presents their signature harmony again. Yeo-ul's clear tone and Wongirl's warm low register blend like two leaves swaying in the wind. A minimal arrangement with acoustic guitar and shaker highlights the purity of the message.",
    imageUrl: 'https://i3.ruliweb.com/img/25/01/16/1946d7c52aaafd4.jpeg',
  },
  {
    id: 26,
    title:
      '[Mysterious sounds of Gangjeong nature] Project Around Surround presents an experimental fusion of East and West',
    publisher: 'News Art',
    date: '2025-01-17',
    url: 'https://www.news-art.co.kr/news/article.html?no=32718',
    description:
      "This work reinterprets Gangjeong's natural scenery through sound. The musical flow from gentle waves to the grandeur of Hallasan blends ancient Indian raga with modern ambient music. The sitar's mystic tone and advanced sound design bridge Eastern tradition and Western modernity.",
    imageUrl: 'https://www.news-art.co.kr/data/photos/20250103/art_17370882782835_3077f9.jpg',
  },
  {
    id: 27,
    ...
    url: 'https://news.mt.co.kr/mtview.php?no=2025020613450122763',
    description:
      "The lyrics portray the anxieties of youth and a longing for a pure life. Jeju symbolizes the possibility of an alternative life and carries hope. The song moves listeners with folk's inherent charm.",
    imageUrl: 'https://thumb.mt.co.kr/06/2025/02/2025020613450122763_1.jpg',
  },
  {
    id: 28,
    ...
    url: 'https://sports.khan.co.kr/article/202502060153003',
    description:
      "'Seoul Night' succeeds in touching listeners through folk's appeal without excessive formal experiments. Beginning with a lyrical monologue and ending with the blessing \"Live well, my friend,\" its structure shows a process in which personal worries expand into solidarity with contemporaries.",
    imageUrl:
      'https://images.khan.co.kr/article/2025/02/06/news-p.v1.20250206.9e168b0306d64ee8ab38e308df22e191_P1.webp',
  },
  {
    id: 29,
    title:
      "Twelve musicians resist war and violence, sing for peace - 'To You in a Distant Place Whose Name I Don't Know' released",
    publisher: 'News Art',
    date: '2025-02-07',
    url: 'https://www.news-art.co.kr/news/article.html?no=32724',
    description:
      "Musicians yearning for peace around the world raised one voice. The album, capturing the pain of Ukraine's war, ongoing civilian massacres in Gaza, and the long-unresolved division of the Korean Peninsula, will be released digitally at 2 p.m. on February 7.",
    imageUrl: 'https://www.news-art.co.kr/data/photos/20250206/art_17388988747253_d7feea.jpg',
  },
  {
    id: 30,
    ...
    url: 'https://www.ijejutoday.com/news/articleView.html?idxno=400217',
    description:
      'The 2nd Gangjeong Peace Music Camp will be held on the 14th around Halmae Water Restaurant (2835-1 Gangjeong-dong, Seogwipo). Under the slogan "A festival for all who sing for peace," musicians of various genres will participate and deliver a message of peace.',
    imageUrl: 'https://cdn.ijejutoday.com/news/photo/202506/400217_400434_1722.jpg',
    eventType: 'camp',
    eventYear: 2025,
  },
  {
    ...
    url: 'https://www.newsnjeju.com/news/articleView.html?idxno=220836',
    description:
      'The 2nd Gangjeong Peace Music Camp concluded successfully. It was a meaningful gathering where citizens and artists came together to share the values of anti-war and peace.',
    imageUrl: 'http://www.newsnjeju.com/news/thumbnail/202506/220836_287179_4455_v150.jpg',
    eventType: 'camp',
    eventYear: 2025,
  },
  {
    ...
    url: 'https://www.newsnjeju.com/news/articleView.html?idxno=218234',
    description:
      "The Gangjeong Peace Music Camp organizing committee held a press conference urging guarantees for peaceful cultural events and citizens' rights to enjoy culture.",
    imageUrl: 'http://www.newsnjeju.com/news/thumbnail/202505/218234_282572_2715_v150.jpg',
    eventType: 'camp',
    eventYear: 2025,
  },
